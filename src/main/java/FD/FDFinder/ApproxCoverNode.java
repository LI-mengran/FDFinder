...
//        mutexMap = mutex;
    ...
    HyperEdge chooseAnCanHitUncovEdge() {
        ...
        return Collections.min(canHitUncov, cmp);     // TODO: compare max and min
    ...
    ApproxCoverNode getHitChild(int addV, LongBitSet childCand) {
        ...
        return new ApproxCoverNode(childTarget, childVertices, childCand, childCanHitUncov, childCrit);
    }
